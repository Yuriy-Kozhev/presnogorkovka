...
<div class="creative">
    <div class="container">
        ...
        <?php echo do_shortcode('[ajax_load_more category="lyrics" button_label="Загрузить ещё" button_done_label="На сегодня это всё" post_type="post" posts_per_page="6" transition_delay="200" pause="true" scroll="false" offset="6"]'); ?>
