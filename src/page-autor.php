...
<?php get_header();?>
    ...
    <div class="autor">
        <div class="container">
            ...
            <img src="img/posts/vinichenko-s-n/vinichenko-s-n.jpg" alt="Аватар" class="autor__avatar">
            <p class="autor__bio">Краевед, историк, писатель, поэт.</p>
            ...
            <nav aria-label="Рубрики">
                <ul class="autor__tags">
                    <li><a href="#" class="btn">рассказы</a></li>
                    <li><a href="#" class="btn">очерки</a></li>
                    <li><a href="#" class="btn">миниатюры</a></li>
                    <li><a href="#" class="btn">статьи</a></li>
                    <li><a href="#" class="btn">стихи</a></li>
                    <li><a href="#" class="btn">юмор</a></li>
                    <li><a href="#" class="btn">история</a></li>
                    <li><a href="#" class="btn">биографии</a></li>
                </ul>
            </nav>
        </div>
    </div>
